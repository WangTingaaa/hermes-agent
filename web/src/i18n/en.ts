...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "This restarts the Mira Agent gateway process. Connected channels and active sessions will reconnect afterward.",
    ...
    updateHermesConfirmTitle: "Update Mira Agent?",
    updatingHermes: "Updating Mira Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Mira Agent plugins (`hermes plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Mira Agent doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Mira badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Mira Agent session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Mira Agent more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Mira Agent sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Mira Agent is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
