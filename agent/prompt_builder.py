...
DEFAULT_AGENT_IDENTITY = (
    ...
    f"You are {BRAND_AGENT_NAME}, built by MesoInsights. Be direct: match the length of your reply to the weight of the ask "
...
HERMES_AGENT_HELP_GUIDANCE = (
    ...
    f"You run on {BRAND_AGENT_NAME} (by MesoInsights). When the user needs help with {BRAND_AGENT_NAME} itself — configuring, "
    ...
    f"before configuring, modifying, or troubleshooting {BRAND_AGENT_NAME} so you don't guess or invent workarounds."
)
...
STEER_CHANNEL_NOTE = (
    ...
    f"Mid-turn, the user can steer you: {BRAND_AGENT_NAME} appends their message to the end of a tool result, wrapped exactly as:\n"
    f"{STEER_MARKER_OPEN}\n<their message>\n{STEER_MARKER_CLOSE}\n"
...
PLATFORM_HINTS = {
    ...
    "tui": (
        ...
        f"You are in the {BRAND_AGENT_NAME} terminal UI (TUI). Files: there is no attachment channel and MEDIA:/path tags "
