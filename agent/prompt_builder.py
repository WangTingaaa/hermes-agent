...
HERMES_AGENT_HELP_GUIDANCE = (
    ...
    f"You run on {BRAND_AGENT_NAME} (by MesoInsights). When the user needs help with "
    f"{BRAND_AGENT_NAME} itself — configuring, setting up, using, extending, or troubleshooting "
    ...
    f"modifying, or troubleshooting {BRAND_AGENT_NAME} so you don't guess or invent workarounds."
)
...
STEER_CHANNEL_NOTE = (
    ...
    f"Mid-turn, the user can steer you: {BRAND_AGENT_NAME} appends their message to the "
...
PLATFORM_HINTS = {
    ...
    "tui": (
        ...
        f"You are in the {BRAND_AGENT_NAME} terminal UI (TUI). Files: there is no "
