"""
Configuration management for Mira Agent.
...
Mira Agent runs as a published image (nousresearch/hermes-agent), not a
...
DEFAULT_CONFIG = {
    ...
    "whatsapp": {
        ...
        # Default (None) uses the built-in "⚕ *Mira Agent*" header.
...
def show_config():
    ...
    print(color("│              ⚕ Mira Configuration                    │", Colors.CYAN))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.CYAN))
