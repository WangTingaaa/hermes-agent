...
def build_serve_parser(
    *, cmd_dashboard: Callable, add_help: bool = True, exit_on_error: bool = True,
    ...
    parser = argparse.ArgumentParser(
        prog="hermes serve",
        description="Run the Mira backend server - the JSON-RPC/WebSocket gateway the "
...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the Mira Agent web dashboard for managing config, API keys, and sessions",
    )
    ...
    serve_parser = subparsers.add_parser(
        "serve",
        help="Start the Mira backend server (headless; powers the desktop app and remote backends)",
        description="Run the Mira backend server — the JSON-RPC/WebSocket gateway the "
            "desktop app and remote clients connect to. Headless: it never opens "
            "a browser UI.")
