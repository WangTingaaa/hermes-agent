...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running Mira Agent version."""
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        """Handle /update command — update Mira Agent to the latest version.
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Mira Agent')}"
