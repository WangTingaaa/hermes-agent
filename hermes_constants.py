"""Shared constants for Mira Agent.
...
# User-facing product name (UI, CLI banner, agent identity). Internal package and
# command names remain "hermes" for compatibility.
