...
import { BUILTIN_THEMES, BUILTIN_THEME_LIST, DEFAULT_SKIN_NAME, DEFAULT_TYPOGRAPHY, nousTheme } from './presets'
...
function withWenjingAccent(theme: DesktopTheme, primaryColor: string, mode: 'light' | 'dark'): DesktopTheme {
  ...
  return {
    ...
    colors: {
      ...
      primaryForeground: readableInk(primaryColor),
      secondary,
      secondaryForeground: readableInk(secondary),
      accent,
      accentForeground: readableInk(accent),
      ring: primaryColor,
      midground: primaryColor,
      midgroundForeground: readableInk(primaryColor),
...
/** Sync the desktop skin with the active Mira backend theme on connect. */
