...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should MesoInsights look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} ${BRAND_AGENT_NAME} need to see?`,
    ...
    {
      headline: `What should ${label} ${BRAND_AGENT_NAME} tackle?`,
...
const WORDMARK = BRAND_AGENT_WORDMARK
