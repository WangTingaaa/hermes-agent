...
export function MiraAboutSettings() {
  ...
  const agentVersion = versions.agent
    ? `Mira Agent v${versions.agent}`
    : versions.loaded
    ...
    <SettingsContent>
      <div className="flex flex-col items-center gap-3 pt-6 pb-2 text-center">
        ...
        <div>
          ...
          {/* <p className="mt-1 text-xs text-muted-foreground">{a.version(versions.desktop)}</p> */}
          <p className="mt-1 text-xs text-muted-foreground">{agentVersion}</p>
        </div>
      </div>
