...
export const en: Translations = {
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Mira and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Mira.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Mira. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Mira',
    continue: 'Continue in Mira',
  ...
  boot: {
    ready: 'Mira Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Mira settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Mira backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Mira Desktop…'
    },
    errors: {
      backgroundExited: 'Mira background process exited.',
      backgroundExitedDuringStartup: 'Mira background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Mira Desktop.',
    ...
    native: {
      ...
      inputBody: 'Mira is waiting for your response.',
      turnDoneTitle: 'Mira finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Mira defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Mira backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Mira backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Mira is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Mira asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Mira was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Mira was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Mira follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Mira can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Mira when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Mira walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Mira is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Mira, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Mira runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Mira only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Mira',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Mira checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Mira configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Mira.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Mira gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Mira Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Mira Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Mira runtime managed by this app.',
      kindRemoteDesc: 'A Mira gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Mira Cloud account.',
      kindSshDesc: 'A Mira install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Mira manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Mira Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Mira backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Mira backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Mira backend.',
      ...
      cloudDesc: 'Sign in once to Mira Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Mira Cloud',
      cloudSignIn: 'Sign in to Mira Cloud',
      cloudSignedIn: 'Signed in to Mira Cloud',
      cloudNeedsSignIn: 'Sign in to Mira Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Mira Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Mira Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Mira Cloud',
      cloudSignedOutMessage: 'Cleared the Mira Cloud session.',
      ...
      restartingMessage: 'Mira Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Mira ${version}` : ''}`,
      ...
      sshDesc:
        'Mira is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Mira path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Mira found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Mira runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Mira is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Mira path.',
      sshErrPlatform:
        'Unsupported remote platform. Mira Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Mira on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Mira. Review the exact configuration below — it comes from the link, not from Mira.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Mira starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Mira ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Mira runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Mira browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Mira builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Mira to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Mira to generate pets.',
      backgroundHint: 'You can close this — Mira will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Mira desktop' },
    ...
    hermesActiveSessions: (version, count) => `Mira ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Mira you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Mira environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Mira did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Mira will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Mira backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Mira. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Mira backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Mira...',
    placeholderReconnecting: 'Reconnecting to Mira…',
    ...
    attachUrlDesc: 'Mira will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Mira…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Mira…',
    ...
    unsupportedMessage: 'This version of Mira can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Mira from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Mira will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Mira desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Mira updater takes over in its own window and reopens Mira automatically when it’s done. Please don’t reopen Mira yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Mira reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Mira reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Mira?',
    blockerBody:
      'Mira needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Mira',
    foreignBlockerBody:
      'Mira can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Mira can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Mira needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Mira Desktop',
    setupChoiceDesc:
      'Connect this app to a Mira gateway you already run, or install Mira locally on this computer.',
    connectExistingTitle: 'Connect to existing Mira',
    ...
    installLocalTitle: 'Install Mira locally',
    installLocalDesc: 'Download Mira, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Mira Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Mira',
    remoteSetupDesc: 'Enter your gateway URL. Mira Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Mira gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Mira gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Mira CLI or desktop instance is running. Stop any running Mira instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    preparingInstall: 'Mira is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Mira…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Mira',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Mira at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Mira connects automatically',
    ...
    authorizeThere: 'Authorize Mira there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Mira there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Mira will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Mira is restarting...',
      askRestart: 'Ask Mira to restart the server',
      lookingRestart: taskId => `Mira is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Mira is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Mira to open a page.',
      finishedRestarting: message => `Mira finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Mira could not restart the server.',
      stillWorking:
        'Mira is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Mira is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Mira gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Mira won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Mira needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Mira needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Mira Desktop to use Save Image.',
    restartToSaveImages: 'Restart Mira Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Mira loads when the work calls for them.'
      },
      messaging: {
        title: 'Mira away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Mira made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Mira — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
