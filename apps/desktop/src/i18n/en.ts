...
export const en: Translations = {
  ...
  updates: {
    ...
    blockerBody: 'Mira needs to stop these local previews before updating. This will not modify or delete your files.',
  ...
  install: {
    ...
    setupChoiceDesc: 'Connect this app to a Mira gateway you already run, or install Mira locally on this computer.',
