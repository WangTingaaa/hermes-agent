...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `正在執行 llama.cpp ${tag}（${backend}）——Mira 提供的最新組建。`,
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'Mira Agent 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
    sudoPlaceholder: 'sudo 密碼',
    secretTitle: '需要密鑰',
    secretDesc: 'Mira Agent 需要一個憑證才能繼續。',
