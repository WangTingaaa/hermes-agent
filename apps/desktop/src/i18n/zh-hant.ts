...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      ...
      focusedHint: '完成提醒僅在 Mira Agent 位於背景時觸發。',
      kinds: {
        approval: {
          label: '需要核准',
    ...
    appearance: {
      ...
      pet: {
        ...
        restartHint: '寵物功能需要重新啟動——目前執行的應用在此功能加入前啟動。請結束並重新開啟 Mira Agent，然後回到此處。',
        scaleTitle: '大小',
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'Mira Agent Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Mira Agent 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      localTitle: '本機閘道',
      localDesc: '在 localhost 啟動私有 Mira Agent 後端。這是預設方式，可離線使用。',
      remoteTitle: '遠端閘道',
      remoteDesc:
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Mira Agent 推論閘道狀態',
      agents: '代理',
      closeAgents: '關閉代理',
      openAgents: '開啟代理',
      subagents: count => `${count} 個子代理`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message => `Mira Agent 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
