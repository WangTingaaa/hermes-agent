...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active MesoInsights profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show MesoInsights agent version', surface: exec() },
