...
**The native desktop app for [Mira Agent](../../README.md) — the self-improving AI agent from [Nous Research](https://nousresearch.com).** Same agent, same skills, same memory as the CLI and gateway, in a polished native window — chat with streaming tool output, side-by-side previews, a file browser, voice, and settings, no terminal required. Available for **macOS, Windows, and Linux**.
...
first launch it can install the Mira Agent runtime into `HERMES_HOME`
...
- **Mira Agent** runs as a headless `hermes serve` process and exposes the
