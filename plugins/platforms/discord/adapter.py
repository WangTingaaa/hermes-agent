...
_NATIVE_SLASH_COMMANDS: tuple = (
    ...
    ("stop", "Stop the running Mira agent", (), "/stop", "Stop requested~"),
    ...
    ("voice", "Toggle voice reply mode",
     ...
     "/voice {mode}", None),
    ("update", "Update Mira Agent to the latest version", (), "/update", "Update initiated~"),
    ("restart", "Gracefully restart the Mira gateway", (), "/restart", "Restart requested~"),
