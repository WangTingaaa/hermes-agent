...
not replace Mira Agent's planner, tools, memory, model provider routing, or
...
With this plugin enabled, Mira Agent can:
...
export HERMES_NEMO_RELAY_ATIF_AGENT_NAME='Mira Agent E2E'
...
```json
{
  ...
  "session_id": "docs-parent-session",
  "agent": {"name": "Mira Agent E2E", "version": "docs-example", "model_name": "qwen3.6:35b"},
  "steps": [
    {
      "source": "agent",
